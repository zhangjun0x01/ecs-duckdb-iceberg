...
spark.sql(
    """
CREATE OR REPLACE TABLE partition_decimal_integer (
    partition_col DECIMAL(8,4),
    user_id BIGINT,
    event_type STRING
)
USING iceberg
...
spark.sql(
    """
INSERT INTO partition_decimal_integer VALUES
  (42.563, 12345, 'click'),
  (1.23, 67890, 'purchase'),
...
parquet_files = glob.glob("data/persistent/partition_decimal_integer/data/partition_col=*/*.parquet")
