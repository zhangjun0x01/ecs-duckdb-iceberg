...
spark.sql(
    """
CREATE OR REPLACE TABLE partition_decimal_smallint (
    partition_col DECIMAL(3,2),
    user_id BIGINT,
    event_type STRING
)
USING iceberg
...
spark.sql(
    """
INSERT INTO partition_decimal_smallint VALUES
  (1.23, 12345, 'click'),
  (4.56, 67890, 'purchase');
"""
)
...
parquet_files = glob.glob("data/persistent/partition_decimal_smallint/data/partition_col=*/*.parquet")
