...
void IcebergAddSnapshot::WriteManifestFile(CopyFunction &copy, DatabaseInstance &db, ClientContext &context) {
...
void IcebergAddSnapshot::WriteManifestList(CopyFunction &copy, DatabaseInstance &db, ClientContext &context) {
	auto &allocator = db.GetBufferManager().GetBufferAllocator();
