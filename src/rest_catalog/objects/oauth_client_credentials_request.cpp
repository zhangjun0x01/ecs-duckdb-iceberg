...
string OAuthClientCredentialsRequest::TryFromJSON(yyjson_val *obj) {
	...
	if (!grant_type_val) {
		...
		if (yyjson_is_str(grant_type_val)) {
			...
			return "OAuthClientCredentialsRequest property 'grant_type' is not of type 'string'";
		}
	}
	...
	if (!client_id_val) {
		...
		if (yyjson_is_str(client_id_val)) {
			...
			return "OAuthClientCredentialsRequest property 'client_id' is not of type 'string'";
		}
	}
	...
	if (!client_secret_val) {
		...
		if (yyjson_is_str(client_secret_val)) {
			...
			return "OAuthClientCredentialsRequest property 'client_secret' is not of type 'string'";
		}
	}
	...
	if (scope_val) {
		...
		if (yyjson_is_str(scope_val)) {
			...
			return "OAuthClientCredentialsRequest property 'scope' is not of type 'string'";
		}
	}
	return string();
}
